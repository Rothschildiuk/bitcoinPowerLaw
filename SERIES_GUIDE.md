...
## Special Behavior
- Bitcoin is the only series with currency switching (`EUR`, `USD`, `UAH`, `RUB`, `GOLD`, `SILVER`, `COPPER`, `ALUMINUM`, `IRON`, `OIL`, `US_HOUSING`) and supports both PowerLaw and LogPeriodic.
